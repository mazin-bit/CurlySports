...
const SPORT_CONFIGS: Record<string, SportConfig> = {
  football: {
    ...
    keywords: ["live football scores", "football scores today", "Premier League scores", "La Liga standings", "football match today", "soccer scores", "EPL results", "Champions League scores"],
    espnSport: "soccer",
    espnLeague: "eng.1",
  ...
  cricket: {
    ...
    keywords: ["live cricket score", "IPL score today", "IPL 2026 standings", "cricket match live", "T20 World Cup scores", "cricket scores", "ball by ball", "cricket live updates"],
    espnSport: "cricket",
    espnLeague: "icc",
  ...
  basketball: {
    ...
    keywords: ["NBA scores today", "basketball live scores", "NBA standings", "NBA stats", "basketball scores", "NBA playoffs", "NBA live"],
  ...
  tennis: {
    ...
    keywords: ["tennis scores live", "ATP rankings", "tennis results today", "Grand Slam scores", "Wimbledon scores", "tennis live", "WTA rankings"],
    espnSport: "tennis",
    espnLeague: "atp",
  ...
  f1: {
    ...
    keywords: ["F1 standings 2026", "F1 race results", "Formula 1 live", "F1 driver standings", "F1 constructor standings", "Grand Prix results", "F1 qualifying"],
    espnSport: "racing",
    espnLeague: "f1",
  ...
  baseball: {
    ...
    keywords: ["MLB scores today", "baseball standings", "MLB live", "baseball scores", "MLB standings", "MLB stats", "baseball live scores"],
    espnSport: "baseball",
    espnLeague: "mlb",
    leagues: ["MLB", "MiLB"],
    faq: [
  ...
  nfl: {
    ...
    keywords: ["NFL scores today", "NFL standings 2026", "football scores", "NFL live", "NFL stats", "NFL playoffs", "Super Bowl"],
    espnSport: "football",
    espnLeague: "nfl",
  ...
  hockey: {
    ...
    keywords: ["NHL scores today", "hockey standings", "NHL live", "hockey scores", "NHL stats", "NHL playoffs", "Stanley Cup"],
    espnSport: "hockey",
    espnLeague: "nhl",
    leagues: ["NHL", "KHL"],
    faq: [
  ...
  mma: {
    ...
    keywords: ["UFC results", "MMA fights today", "UFC rankings", "UFC fight card", "MMA scores", "UFC live", "UFC tonight"],
    espnSport: "mma",
    espnLeague: "ufc",
